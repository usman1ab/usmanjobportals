        ...
        <nav class="navbar navbar-expand-lg navbar-bg">
          ...
          <div class="brand-logo">
            <a class="navbar-brand" href="{{ url('/') }}" id="menu-action">
              ...
              <!--<span>{{ config('app.adminName', __('message.nave_name')) }}</span>-->
              ...
              <li class="nav-item dropdown show">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                  ...
                  onclick="event.preventDefault();
                                document.getElementById('logout-form').submit();"><i class="material-icons">exit_to_app</i>{{ __('message.logout') }}</a>
        ...
        <ul>
          ...
          <li><a href="">
            <i class="material-icons mr-2">
              ...
              @lang('message.setting')
                </a></li>
          <li><a href="{{ route('logout') }}"
            onclick="event.preventDefault();
                          document.getElementById('logout-form').submit();"><i class="material-icons mr-2">exit_to_app</i>@lang('message.logout')</a></li>
                  <form id="logout-form" action="{{ route('logout') }}" method="POST" class="d-none">
                    @csrf
                </form>
        </ul>
