...
Route::middleware('admin')->prefix('dashboard')->group(function () { 
  ...
  Route::get('/job/applicants', [DashboardController::class, 'applicants'])->name('applicants');
    ...
    Route::post('/intervie', [DashboardController::class, 'intervie'])->name('intervie');
    Route::get('/intervi', [DashboardController::class, 'interviews'])->name('intervi');
    Route::post('/deleteInterview', [DashboardController::class, 'deleteInterview'])->name('deleteInterview');
    Route::get('/interviewtoggle/{id}/{name}', [DashboardController::class, 'interviewtoggle'])->name('interviewtoggle');
    Route::post('/admin/reschedule/{id}', [DashboardController::class, 'reschedule'])->name('admin.reschedule');
    Route::get('/interview/feedbacks/{id}', [DashboardController::class, 'feedbacks'])->name('feedbacks');

    // All Staff
    Route::get('/companies/staff', [DashboardController::class, 'getStaff'])->name('adminStaff');
    Route::get('/staff/edit/{id}', [DashboardController::class, 'editSatff'])->name('staffEditStaff');
    Route::post('/staff/update/{id}', [DashboardController::class, 'updateStaff'])->name('adminStaffUpdate');
    Route::post('/staff/delete', [DashboardController::class, 'destroyStaff'])->name('adminStaffDelete');
