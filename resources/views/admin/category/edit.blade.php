       ...
       <div class="content-header">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">@lang('categories.edit') : {{ $category->name }}</li>
          </ol>
        </nav>
    ...
    <div class="card-body mt-1 mb-5">
        <form action="{{ route('adminCatUpdate', [$category->id]) }}" method="post">
            ...
            <div class="form-group pt-2 row">
                ...
                <div class="col-md-4">
                    <button class="theme-primary-btn btn btn-success" type="submit">@lang('categories.update_category')</button>
                </div>
            </div>
