<footer class="site-footer">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4">
          <h3 class="footer-heading mb-4 text-dark">About</h3>
          <p style="color:#625b58">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repellat quos rem ullam, placeat amet.</p>
          <p><a href="#" class="btn btn-dark pill text-white px-4">Read More</a></p>
        </div>
        <div class="col-md-6">
          <div class="row">
            <div class="col-md-6">
              <h3 class="footer-heading mb-4 text-dark">Quick Menu</h3>
            ...
            <div class="col-md-6">
              <h3 class="footer-heading mb-4 text-dark">Categories</h3>
                <ul class="list-unstyled">
        ...
        <div class="col-md-2">
          <div class="col-md-12"><h3 class="footer-heading mb-4 text-dark">Social Icons</h3></div>
            <div class="col-md-12">
              <p>
