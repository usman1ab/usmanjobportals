...
<div class="unit-5 overlay" style="background-image: url({{ asset('uploads/banner') }}/{{ $company->banner }});">
    <div class="container text-center">
      ...
      <p class="mb-0 unit-6"><a href="/" style="color: #55C4CF;" >@lang('home.home')</a> <span class="sep"> > <a style="color: #55C4CF;" href="{{ route('alljobs') }}">@lang('job.jobs')</a> </span> <span><span class="sep m-0"> ></span> @lang('validation.company_details')</span></p>
    </div>
</div>
          ...
          <div class="p-4 bg-white">
            ...
            <div class="mb-4 mb-md-4 mr-5">
             <div class="job-post-item-header">
                ...
                <p class="mt-3"><strong>@lang('validation.company_details')</strong> &nbsp;{{ $company->description }}</p>
                <p><strong>@lang('validation.slogan')</strong>&nbsp;{{ $company->slogan }}</p>
                <p><strong>@lang('job.address')</strong>&nbsp;{{ $company->address }}</p>
                <p><strong>@lang('message.phone')</strong>&nbsp;{{ $company->phone }}</p>
                <p><strong>@lang('validation.website') </strong>&nbsp;<a target="_blank" href="{{ $company->website }}">{{ $company->website }}</a></p>
              ...
              <a href="{{ route('job.show', [$job->id, $job->slug]) }}" class="job-item d-block d-md-flex align-items-center  border-bottom
                ...
                <div class="job-category align-self-center">
                  <div class="p-3">
                    ...
                    <span class="text-info p-2 rounded border border-info">@lang('validation.apply_now')</span>
                  </div>
                </div>
              </a>
