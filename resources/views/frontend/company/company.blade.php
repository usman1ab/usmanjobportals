...
<div class="unit-5 overlay" style="background-image: url({{ asset('external/images/hero_2.jpg') }})">
    <div class="container text-center">
      ...
      font-size: 2.5rem;">@lang('validation.all_companies')</strong></h1>
      <p class="mb-0 unit-6"><a href="/">@lang('home.home')</a> <span class="sep"> > <a href="{{ route('company') }}">@lang('footer.company')</a> </span> <span><span class="sep m-0"> ></span>@lang('validation.list')</span></p>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="featured-title">
                    <h2>@lang('validation.featured_companies')</h2>
                </div>
            </div>
        </div>
        <div class="row">
